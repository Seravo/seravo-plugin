        ...
        <div class="postbox-container">
          ...
          <!--Second postbox: Cache status-->
            <div id="dashboard_activity" class="postbox">
              <button type="button" class="handlediv button-link" aria-expanded="true">
                <span class="screen-reader-text">Toggle panel: <?php _e('Cache status', 'seravo'); ?></span>
                <span class="toggle-indicator" aria-hidden="true"></span>
              </button>
              <h2 class="hndle ui-sortable-handle"><span><?php _e('Cache status', 'seravo'); ?></span></h2>
        ...
        <div class="postbox-container">
          <div id="side-sortables" class="meta-box-sortables ui-sortable">
            ...
            <div id="dashboard_primary" class="postbox">
              ...
              <h2 class="hndle ui-sortable-handle">
                <span><?php _e('Data Integrity', 'seravo'); ?></span>
              </h2>
              <div class="inside" style="padding: 10px;">
                <h3><?php _e('WordPress core', 'seravo'); ?></h3>
